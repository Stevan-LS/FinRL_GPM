...
def main():
    ...
    st.set_page_config(page_title="Financial Trading Advisor", 
                       page_icon="📈", 
                       layout="wide", 
    ...
    # Sidebar navigation
    st.sidebar.markdown('<div class="sidebar-title">Financial Trading Advisor</div>', unsafe_allow_html=True)

    # Detect clicks and update session state
    if st.sidebar.button('My portfolios'):
        st.session_state.page = "My portfolios"
    if st.sidebar.button('Trades of the day'):
        st.session_state.page = "Trades of the day"
    ...
    if st.session_state.page == 'My portfolios':
        ...
        selected_stocks = st.multiselect("Select portfolio companies", options=stocks, default=["AAPL", "FB", "INTC", "MSFT", "NVDA"])
        ...
        # Example list of portfolio names
        names = ["Tech", "Healthcare", "Mix"]

        # Display the list of names as a bulleted list
        st.markdown("<ul>" + "".join([f"<li>{name}</li>" for name in names]) + "</ul>", unsafe_allow_html=True)

        
    elif st.session_state.page == 'Trades of the day':
        st.title("Trades of the Day")
        st.write("These are your trading recommandations of the day.")

    elif st.session_state.page == 'Backtesting':
        st.title("Backtesting")
        
        #Selection of the portfolio
        st.selectbox("Select a portfolio:", ["Tech", "Healthcare", "Mix"])
        selected_stocks = ["AAPL", "CMCSA", "CSCO", "FB", "HBAN", "INTC", "MSFT", "MU", "NVDA", "QQQ", "XIV"]
